...
@Component({
  ...
  template: `
    <div class="resize-container-2 min-h-screen h-full bg-surface-50 dark:bg-surface-950">
      <div class="bg-surface-0 dark:bg-surface-900 py-4 px-12 border-b border-surface-200 dark:border-surface-800 flex items-center justify-between relative lg:static">
        ...
        <div class="items-center grow justify-between hidden lg:flex absolute lg:static w-full bg-surface-0 dark:bg-surface-900 left-0 top-full px-12 lg:px-0 z-50 shadow lg:shadow-none">
          <ul class="list-none p-0 py-4 lg:py-0 m-0 flex grow lg:items-center lg:justify-center text-surface-900 dark:text-surface-0 select-none flex-col lg:flex-row cursor-pointer">
            ...
            <li>
              <a class="flex px-0 lg:px-8 py-2 hover:text-primary font-medium transition-colors duration-150">
                <span>Corporate</span>
              </a>
            </li>
            <li>
