...
@Component({
  ...
  template: `
    <div class="resize-container-7 min-h-screen h-full bg-surface-50 dark:bg-surface-950">
      <div class="bg-surface-0 dark:bg-surface-900 py-0 px-12 shadow flex items-center justify-between relative lg:static min-h-20">
        ...
        >
          <ul
            class="list-none p-0 py-4 h-full lg:py-0 m-0 flex grow lg:items-center lg:justify-end text-surface-900 dark:text-surface-0 select-none flex-col lg:flex-row cursor-pointer lg:min-h-20"
          >
