    ...
    <div class="bg-surface-0 dark:bg-surface-900 px-6 py-20 md:px-12 lg:px-20 flex flex-col gap-8">
      <div class="flex flex-col gap-8">
        <div class="flex flex-col gap-4">
          <div class="text-surface-900 dark:text-surface-0 text-4xl font-semibold leading-tight">Get 25% Discount Today!</div>
          <div class="text-surface-600 dark:text-surface-400 text-lg leading-tight">Sign up our email list and know all about new collections of Peak</div>
        </div>
        <div class="md:w-[402px] flex items-center gap-4 bg-surface-0 dark:bg-surface-900 border border-surface-200 dark:border-surface-700 rounded-[33px] py-2 pl-4 pr-2">
          <input pInputText placeholder="Enter your email" class="flex-1 border-0! bg-transparent! leading-normal! shadow-none! p-0! text-surface-400! dark:text-surface-500!" />
          <button pButton class="px-3! py-2! font-medium! bg-primary! border-primary! rounded-4xl!">
      ...
      <div class="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-8">
        <div class="flex flex-col gap-8">
          <div class="flex flex-col gap-4">
            ...
            <div class="text-surface-600 dark:text-surface-400 leading-normal">
              Aliquam id diam maecenas ultricies.<br />
              Faucibus pulvinar elementum<br />
              integer enim.
            </div>
          </div>
          <div class="flex gap-2">
            @for (icon of socialIcons; track icon) {
              <a
                tabIndex="0"
                class="cursor-pointer w-8 h-8 bg-surface-0 dark:bg-surface-900 border border-surface-50 dark:border-surface-800 hover:opacity-75 transition-colors flex items-center justify-center rounded-full"
              >
                <i [ngClass]="['pi', 'pi-' + icon, 'text-surface-900', 'dark:text-surface-0']"></i>
              </a>
            }
          </div>
        </div>
        <div class="flex flex-col gap-6">
          <div class="text-surface-900 dark:text-surface-0 text-lg font-medium leading-tight">Company</div>
          <div class="flex flex-col gap-4">
            @for (item of companyLinks; track item) {
              <a tabIndex="0" class="text-surface-700 dark:text-surface-400 hover:text-surface-900 dark:hover:text-surface-0 leading-tight transition-colors cursor-pointer">
                {{ item }}
              </a>
            }
          </div>
        ...
        <div class="flex flex-col gap-6">
          <div class="text-surface-900 dark:text-surface-0 text-lg font-medium leading-tight">Account</div>
          <div class="flex flex-col gap-4">
        ...
        <div class="flex flex-col gap-6">
          <div class="text-surface-900 dark:text-surface-0 text-lg font-medium leading-tight">Legal</div>
          <div class="flex flex-col gap-4">
...
export class __CLASS_NAME__ {
  socialIcons = ['twitter', 'facebook', 'youtube', 'google'];
