...
@Component({
  ...
  template: `
    <section class="bg-surface-0 dark:bg-surface-950 gap-3 px-6 py-20 md:px-12 lg:px-20">
      <h2 class="text-surface-900 dark:text-surface-0 text-4xl font-semibold text-center leading-tight">The best will be with you</h2>
      <p class="max-w-192 mx-auto text-center text-surface-700 dark:text-surface-400 mt-4 mb-6 leading-normal">
        Elit eu id diam egestas tincidunt aliquam vitae pharetra. Metus arcu id ut cursus ultrices id diam. Rhoncus sollicitudin ullamcorper nunc malesuada leo sit odio amet.
      </p>
      <div class="w-fit mx-auto">
        <a href="https://angular.dev" target="_blank" rel="noopener noreferrer">
          <button pButton rounded text>
            <span pButtonLabel>All Sponsor</span>
            <i pButtonIcon class="pi pi-arrow-right"></i>
          </button>
        </a>
      </div>
      <div class="max-w-2xl lg:max-w-6xl mx-auto mt-12 md:px-8 lg:px-14 grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div class="bg-surface-50 dark:bg-surface-900 px-6 py-5 rounded-2xl border border-surface-100 dark:border-surface-800 flex items-center justify-center gap-4">
          ...
          <span class="text-xl text-surface-900 dark:text-surface-0 font-semibold leading-6">Limerantz</span>
        </div>
        <div class="bg-surface-50 dark:bg-surface-900 px-6 py-5 rounded-2xl border border-surface-100 dark:border-surface-800 flex items-center justify-center gap-4">
          <svg xmlns="http://www.w3.org/2000/svg" width="33" height="32" viewBox="0 0 33 32" fill="none" class="w-10 h-10">
            <path
          ...
          <span class="text-xl text-surface-900 dark:text-surface-0 font-semibold leading-6">Mistranet</span>
        </div>
        <div class="bg-surface-50 dark:bg-surface-900 px-6 py-5 rounded-2xl border border-surface-100 dark:border-surface-800 flex items-center justify-center gap-4">
          <svg xmlns="http://www.w3.org/2000/svg" width="42" height="42" viewBox="0 0 42 42" fill="none" class="w-10 h-10">
            <path d="M21 0C9.40201 0 0 9.40201 0 21C11.598 21 21 11.598 21 0Z" class="fill-surface-700 dark:fill-surface-200" />
            <path d="M21 42C32.598 42 42 32.598 42 21C30.402 21 21 30.402 21 42Z" class="fill-surface-700 dark:fill-surface-200" />
            <path d="M21 0C32.598 0 42 9.40201 42 21C30.402 21 21 11.598 21 0Z" class="fill-surface-700 dark:fill-surface-200" />
            <path d="M21 42C9.40201 42 -1.01393e-06 32.598 0 21C11.598 21 21 30.402 21 42Z" class="fill-surface-700 dark:fill-surface-200" />
          </svg>
          <span class="text-xl text-surface-900 dark:text-surface-0 font-semibold leading-6">Wavelength</span>
        </div>
        <div class="bg-surface-50 dark:bg-surface-900 px-6 py-5 rounded-2xl border border-surface-100 dark:border-surface-800 flex items-center justify-center gap-4">
          <svg xmlns="http://www.w3.org/2000/svg" width="33" height="32" viewBox="0 0 33 32" fill="none" class="w-10 h-10">
            <path
          ...
          <span class="text-xl text-surface-900 dark:text-surface-0 font-semibold leading-6">BriteMank</span>
        </div>
        <div class="bg-surface-50 dark:bg-surface-900 px-6 py-5 rounded-2xl border border-surface-100 dark:border-surface-800 flex items-center justify-center gap-4">
          <svg xmlns="http://www.w3.org/2000/svg" width="33" height="32" viewBox="0 0 33 32" fill="none" class="w-10 h-10">
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
              d="M7.09219 2.87829C5.94766 3.67858 4.9127 4.62478 4.01426 5.68992C7.6857 5.34906 12.3501 5.90564 17.7655 8.61335C23.5484 11.5047 28.205 11.6025 31.4458 10.9773C31.1517 10.087 30.7815 9.23135 30.343 8.41791C26.6332 8.80919 21.8772 8.29127 16.3345 5.51998C12
